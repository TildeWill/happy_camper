module.exports = {
  ...
  body: p => {
    const footprint = `
    (module "tildewill:Sunrise-Hot-Interchange-Terminal" (layer F.Cu) (tedit 5DD50112)
      ${p.at /* parametric position */}
      (attr virtual)
            
      (fp_text reference ${p.ref} (at -1.037771 -10.340352) (layer "Dwgs.User") hide
        (effects (font (size 1 1) (thickness 0.15)))
      )
      (fp_text value "Connector_SHIT-keyboard" (at 0 -12) (layer "F.Fab") hide
        (effects (font (size 1 1) (thickness 0.15)))
      )
      ...
      (fp_circle (center 0 8) (end 0 4) (width 0.05) (layer "Edge.Cuts"))
